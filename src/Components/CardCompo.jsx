...
import { ArrowRightCircle, Component } from "lucide-react";

// main Mycard Component

const CardCompo = ({ id, title, description, image, price }) => {
return (
    <motion.div
      whileHover={{ y: -8 }}
      ...
      <div className="p-5 text-gray-800">
        ...
        <div className="flex items-center justify-between mt-3 gap-6">
          ...
          <motion.button
            ...
            onClick={() => (window.location.href = `/publicCard/${id}`)}
